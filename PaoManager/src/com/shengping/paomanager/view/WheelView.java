...
//    private ScrollView scrollView;
    ...
    /**
     * �����滻����ʾ����ͼ�������ڵ�һ��wheelView��setOnWheelViewListener�����е��ã��滻�ڶ���wheelView����ʾ����ͼ
     */
    ...
    int offset = OFF_SET_DEFAULT;  // ƫ��������Ҫ����ǰ�������油ȫ��
...
//        	System.out.println("选中�?"+items.get(selectedIndex));
